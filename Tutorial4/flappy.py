...
class PillarPairSprite():
    ...
    def draw(self):
        ...
        self.bottom_pillar_sprite.set_position(
            self.model.x, self.model.y - 400)
...
class FlappyDotWindow(arcade.Window):
    ...
    def start(self):
        ...
        self.pillar_pair_sprites = [PillarPairSprite(
            model=self.world.pillar_pairs[0]), PillarPairSprite(model=self.world.pillar_pairs[1])]
